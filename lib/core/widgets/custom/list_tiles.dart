  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      title: Text(
        text ?? '',
        style: TextStyle(
          color: Theme.of(context).textTheme.titleLarge?.color ?? primaryColor,
        ),
      ),
      onTap: onTap,
    );
...
class ListTilesWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final Color defaultTextColor = Theme.of(context).textTheme.bodyLarge?.color ?? primaryColor;
    final Color defaultIconColor = Theme.of(context).iconTheme.color ?? primaryColor;
